...
- <img src="https://cdn.simpleicons.org/lightning/F7931A" height="14"/> [LightningProx](https://github.com/unixlamadev-spec/lightningprox-mcp) - Pay-per-request AI gateway over Bitcoin Lightning Network. Agents pay 3-10 sats per request using prepaid spend tokens. Supports Claude, GPT-4, and model discovery. No API keys needed.
- <img src="https://cdn.simpleicons.org/solana/9945FF" height="14"/> [SolanaProx](https://github.com/solanaprox/mcp-server) - Pay-per-request AI gateway over Solana/USDC. Agents pay $0.003 per request using Phantom wallet address. Supports Claude, GPT-4, and model discovery. No API keys needed.
- 🤖 [AIProx MCP](https://github.com/unixlamadev-spec/aiprox-mcp) - Open agent registry. Discover autonomous agents by capability and payment rail. Supports Bitcoin Lightning and Solana USDC. No API keys needed.
- <img src="https://cdn.simpleicons.org/bitcoin/F7931A" height="14"/> [LPXPoly MCP](https://github.com/unixlamadev-spec/lpxpoly-mcp) - AI-powered Polymarket analysis paid in Bitcoin sats. Find mispriced markets and edge opportunities. No API keys needed.
